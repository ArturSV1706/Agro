...
// --------------------
const $id_XELSzmenzK = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_9YXvOcq3Hl = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
...
const _sfc_main = /* @__PURE__ */ __vite_ssr_import_4__.defineComponent({
  ...
  async setup(__props, { expose }) {
    ...
    const __returned__ = { showModal, supabase, user, saldoResponse, fluxoResponse, fluxoEntrada, fluxoSaida, saldoResult, detalhe_Tipo_fluxo, detalhe_Categoria, detalhe_Fornecedor, detalhe_Produto, detalhe_Valor, despesaInput, entradaInput, handleSubmitDespesa, handleSubmitEntrada, handleDetalheFluxo };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${__vite_ssr_import_6__.ssrRenderAttrs(_attrs)}><div class="flex flex-row justify-evenly"><div><h3>Fluxo de Entrada</h3><h1>R$ ${__vite_ssr_import_6__.ssrInterpolate($setup.fluxoEntrada.data.toFixed(2))}</h1></div><div><h3>Fluxo de saida</h3><h1>R$ ${__vite_ssr_import_6__.ssrInterpolate($setup.fluxoSaida.data.toFixed(2))}</h1></div><div><h3>Saldo</h3><h1>R$ ${__vite_ssr_import_6__.ssrInterpolate((parseFloat($setup.fluxoEntrada.data) - parseFloat($setup.fluxoSaida.data)).toFixed(2))}</h1></div></div><div class="flex flex-row"><div class="flex flex-row"><form class="flex flex-col"><h1>Adicionar despezas</h1><label for="categoria">Categoria</label><select name="categoria" id="cars" form="carform"><option value="insumo">Insumo</option><option value="combustivel">Combust\xEDvel</option><option value="manutencao">Manuten\xE7\xE3o</option><option value="Financiamento">Financiamento</option></select><label for="fornecedor">Fornecedor</label><input${__vite_ssr_import_6__.ssrRenderAttr("value", $setup.despesaInput.fornecedor)} name="fornecedor" type="text"><label for="nota fiscal">Nota Fiscal</label><input${__vite_ssr_import_6__.ssrRenderAttr("value", $setup.despesaInput.nota_fiscal)} name="nota fiscal" type="number"><label for="produto">Produto</label><input${__vite_ssr_import_6__.ssrRenderAttr("value", $setup.despesaInput.produto)} name="produto" type="text"><label for="valor">Valor</label><input${__vite_ssr_import_6__.ssrRenderAttr("value", $setup.despesaInput.valor)} name="valor" type="number"><button type="button">Criar</button></form></div><div class="flex flex-row"><form class="flex flex-col"><h1>Adicionar Entradas</h1><label for="categoria">Categoria</label><select name="categoria" id="cars" form="carform"><option value="insumo">Insumo</option><option value="combustivel">Combust\xEDvel</option><option value="manutencao">Manuten\xE7\xE3o</option><option value="Financiamento">Financiamento</option></select><label for="fornecedor">Fornecedor</label><input${__vite_ssr_import_6__.ssrRenderAttr("value", $setup.entradaInput.fornecedor)} name="fornecedor" type="text"><label for="nota fiscal">Nota Fiscal</label><input${__vite_ssr_import_6__.ssrRenderAttr("value", $setup.entradaInput.nota_fiscal)} name="nota fiscal" type="number"><label for="produto">Produto</label><input${__vite_ssr_import_6__.ssrRenderAttr("value", $setup.entradaInput.produto)} name="produto" type="text"><label for="valor">Valor</label><input${__vite_ssr_import_6__.ssrRenderAttr("value", $setup.entradaInput.valor)} name="valor" type="number"><button type="button">Criar</button></form></div></div><table class=""><th>A\xE7\xE3o</th><th>Categoria</th><th>Fornecedor</th><th>Produto</th><th>Valor</th><th>Detalhes</th><!--[-->`);
  __vite_ssr_import_6__.ssrRenderList($setup.fluxoResponse.data, (fluxo) => {
    _push(`<tr><td>${__vite_ssr_import_6__.ssrInterpolate(fluxo.tipo_fluxo)}</td><td>${__vite_ssr_import_6__.ssrInterpolate(fluxo.categoria)}</td><td>${__vite_ssr_import_6__.ssrInterpolate(fluxo.fornecedor)}</td><td>${__vite_ssr_import_6__.ssrInterpolate(fluxo.produto)}</td><td>R$ ${__vite_ssr_import_6__.ssrInterpolate(fluxo.valor)}</td><td><button class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button"> Toggle modal </button></td></tr>`);
  });
  _push(`<!--]--></table>`);
  if ($setup.showModal) {
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_vryFKWQeBo = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const __vite_ssr_import_0__ = await __vite_ssr_import__("/components/modalFluxo.vue");
...
const __modules__ = {
  ...
  "/assets/css/tailwind.css": $id_XELSzmenzK,
  ...
  "/pages/index2.vue": $id_vryFKWQeBo,
