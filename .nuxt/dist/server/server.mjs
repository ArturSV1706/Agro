...
// --------------------
const $id_gfmDSqIctd = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
...
// - /pages/index2.vue ($id_SOFbo5iYqU)
// --------------------
const $id_71CurSx79s = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_YASXunauur = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const _sfc_main = {}
const __vite_ssr_import_0__ = await __vite_ssr_import__("vue/server-renderer");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${
    ...
    __vite_ssr_import_0__.ssrRenderStyle({"display":"flex","justify-content":"space-evenly"})
  }"><div><h3>Fluxo de Entrada</h3><h1>R\$50.000,00</h1></div><div><h3>Fluxo de saida</h3><h1>R\$50.000,00</h1></div><div><h3>Saldo da propriedade</h3><h1>R\$50.000,00</h1></div></div><form style="${
    __vite_ssr_import_0__.ssrRenderStyle({"display":"flex","flex-direction":"column"})
  }"><label for="categoria">Categoria</label><select name="categoria" id="cars" form="carform"><option value="insumo">Insumo</option><option value="combustivel">Combustível</option><option value="manutencao">Manutenção</option><option value="Financiamento">Financiamento</option></select><label for="fornecedor">Fornecedor</label><input name="fornecedor" type="text"><label for="nota fiscal">Nota Fiscal</label><input name="nota fiscal" type="number"><label for="produto">Produto</label><input name="produto" type="text"><label for="valor">Valor</label><input name="valor" type="number"><button type="submit">Criar</button></form><table><th>Categoria</th><th>Fornecedor</th><th>Nota Fiscal</th><th>Produto</th><th>Valor</th><tr><td>Insumo</td><td>Coopercampos</td><td>23742309</td><td>Randápe</td><td>R\$ 800,00</td></tr><tr><td>Insumo</td><td>Coopercampos</td><td>23742309</td><td>Randápe</td><td>R\$ 800,00</td></tr><tr><td>Insumo</td><td>Coopercampos</td><td>23742309</td><td>Randápe</td><td>R\$ 800,00</td></tr><tr><td>Insumo</td><td>Coopercampos</td><td>23742309</td><td>Randápe</td><td>R\$ 800,00</td></tr><tr><td>Insumo</td><td>Coopercampos</td><td>23742309</td><td>Randápe</td><td>R\$ 800,00</td></tr><tr><td>Insumo</td><td>Coopercampos</td><td>23742309</td><td>Randápe</td><td>R\$ 800,00</td></tr></table></div>`)
}
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = __vite_ssr_import_1__.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("pages/index2.vue")
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
}
const __vite_ssr_import_2__ = await __vite_ssr_import__("/@id/__x00__plugin-vue:export-helper");

__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_2__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"C:/Users/Artur/Documents/nuxt/template/pages/index2.vue"]])
const meta = undefined
Object.defineProperty(__vite_ssr_exports__, "meta", { enumerable: true, configurable: true, get(){ return meta }});;
}
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_kzvjf4HZfr = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const _sfc_main = {}
const __vite_ssr_import_0__ = await __vite_ssr_import__("vue/server-renderer");
...
const __modules__ = {
  ...
  "/assets/css/tailwind.css": $id_gfmDSqIctd,
  ...
  "/@id/virtual:nuxt:C:/Users/Artur/Documents/nuxt/template/.nuxt/routes.mjs": $id_71CurSx79s,
  ...
  "/pages/index2.vue?macro=true": $id_YASXunauur,
  "/pages/index.vue": $id_FYGDg5l61L,
  "/pages/index2.vue": $id_kzvjf4HZfr,
