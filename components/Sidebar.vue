...
<template>
    <div class=" group/main flex flex-col align-middle fixed z-20 w-[85px] h-[70%] ml-[15px] rounded-2xl bg-escuro top-1/2 transform -translate-y-1/2 transition-all
        ...
        <ul class=" w-[100%]  h-[100%] flex flex-col justify-evenly items-center transition-all ease-in
            ...
            <li class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                ...
                <NuxtLink to="/" class="flex items-center">
                    ...
                    <svg class="scale-[45%] transition-all fill-verde group-hover:fill-claro"
