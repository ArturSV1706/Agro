...
<template>
    <div class=" hidden sm:flex group/main flex-col align-middle fixed z-20 w-[85px] sm:h-[90%] 2xl:h-[70%] ml-[15px] rounded-2xl  bg-escuro top-1/2 transform -translate-y-1/2 transition-all
    hover:w-[230px] hover:justify-start hover:border-claro hover:border-[1px]">
        <div class="flex items-center justify-start mt-6 ml-[2px] ">
            ...
            <h1 class="font-aristotelica font text-3xl text-claro hidden transition-all group-hover/main:block">Saffron
            </h1>
        </div>
        <ul class=" w-[100%]  h-[100%] flex flex-col justify-evenly items-center transition-all ease-in
            ...
            <li class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                ...
                <NuxtLink to="/" class="flex items-center  group-hover/main:w-full">
                    ...
                    <p class="text-verde hidden font-bold transition-all
                            group-hover/main:block group-hover:text-claro">Painel</p>
                </NuxtLink>
            </li>
            <li id="test" class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                ...
                <NuxtLink to="/safras" class="flex items-center group-hover/main:w-full">
                    ...
                    <svg class="sm:scale-[35%] 2xl:scale-[45%] transition-all fill-verde group-hover:fill-claro"
                        xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                        <path
                            d="M22.5 41.5V26.05h-1q-3.2 0-6.025-1.225T10.45 21.35q-2.2-2.25-3.325-5.2T6 10V6h3.9q3.1 0 5.95 1.225t5.1 3.475q1.65 1.7 2.725 3.8 1.075 2.1 1.525 4.45.4-.6.85-1.15.45-.55.95-1.1 2.25-2.25 5.1-3.475Q34.95 12 38.1 12H42v4q0 3.2-1.2 6.15t-3.4 5.2q-2.25 2.25-5.075 3.45Q29.5 32 26.4 32h-.9v9.5Zm.05-18.5q0-3.05-1-5.675T18.8 12.85q-1.75-1.8-4.3-2.825Q11.95 9 9 9q0 3.15.925 5.775.925 2.625 2.675 4.475 2.1 2.25 4.525 3 2.425.75 5.425.75Zm2.95 6q3 0 5.55-.975t4.3-2.825q1.75-1.8 2.7-4.425Q39 18.15 39 15q-3 0-5.55 1.025t-4.3 2.825q-2.15 2.25-2.9 4.7T25.5 29Zm0 0Zm-2.95-6Z" />
                    </svg>
                    <p class="text-verde hidden font-bold transition-all
                            group-hover/main:block group-hover:text-claro">Safras</p>
                </NuxtLink>
            </li>
            <li id="test" class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                     hover:bg-verde rounded-xl group-hover/main:justify-start">
                <NuxtLink to="/estoque" class="flex items-center group-hover/main:w-full">
                    ...
                    <p class="text-verde hidden font-bold transition-all
                            group-hover/main:block group-hover:text-claro">Estoque</p>
                </NuxtLink>
            </li>
            <li id="test" class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                     hover:bg-verde rounded-xl group-hover/main:justify-start">
                <NuxtLink to="/tarefas" class="flex items-center group-hover/main:w-full">
                    ...
                    <p class="text-verde hidden font-bold transition-all
                            group-hover/main:block group-hover:text-claro">Tarefas</p>
                </NuxtLink>
            </li>
            <li id="test" class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                     hover:bg-verde rounded-xl group-hover/main:justify-start">
                <NuxtLink to="/financeiro" class="flex items-center group-hover/main:w-full">
                    ...
                    <p class="text-verde hidden font-bold transition-all
                            group-hover/main:block group-hover:text-claro">Financeiro</p>
                </NuxtLink>
            </li>
            <li id="test" class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                     hover:bg-verde rounded-xl group-hover/main:justify-start">
                <NuxtLink to="/compradores" class="flex items-center group-hover/main:w-full">

                    <svg class="sm:scale-[35%] 2xl:scale-[45%] transition-all fill-verde group-hover:fill-claro"
                        xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
                        <path
                            d="M726-40v-121H606v-60h120v-120h60v120h120v60H786v121h-60ZM104-161v-257H54v-60l44-202h602l45 207v55h-49v167h-60v-167H420v257H104Zm60-60h196v-197H164v197Zm-50-257h572-572ZM98-740v-60h603v60H98Zm16 262h572l-31-142H145l-31 142Z" />
                    </svg>
                    <p class="text-verde hidden font-bold transition-all
                            group-hover/main:block group-hover:text-claro">Compradores</p>
                </NuxtLink>
            </li>
            <li id="test" class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                     hover:bg-verde rounded-xl group-hover/main:justify-start">
            ...
            <li id="test" class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                     hover:bg-verde rounded-xl group-hover/main:justify-start">
                <a href="https://www.youtube.com/watch?v=9EuLwHoX1Po&list=PLvUJTkiYrMAOjIV3abwvV1Uf4Mkc0fVjh"
                    target="_blank" class="flex items-center group-hover/main:w-full">
                    ...
                    <p class="text-verde hidden font-bold transition-all whitespace-nowrap 
                            group-hover/main:block group-hover:text-claro">Minha Conta</p>
                </a>
            ...
            <li id="test" class="group flex items-center justify-evenly w-[80%] transition-all cursor-pointer
                     hover:bg-verde rounded-xl group-hover/main:justify-start">
                <a href="https://wa.me/5549998285337" target="_blank" class="flex items-center group-hover/main:w-full">
                    <svg class="sm:scale-[35%] 2xl:scale-[45%] transition-all fill-verde group-hover:fill-claro"
                        xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                        <path
                    ...
                    <p class="text-verde hidden font-bold transition-all
                            group-hover/main:block group-hover:text-claro">Ajuda</p>
                </a>
            </li>
    ...
    <div class="block sm:hidden">
        <!-- Backdrop -->
        <div @click="moveSidebar('fecha'); $emit('overflowOn')"  :class="`fixed h-screen w-screen top-0 left-0 bg-verde  opacity-60 backdrop-blur-lg overflow-y-hidden ${x_transform}`"></div>
        <!--  -->
        <button @click="moveSidebar('abre'); $emit('overflowOff')"  type="button"
            class="inline-flex items-center text-sm text-escuro rounded-lg sm:hidden ">
        ...
        <aside id="sidebar" :class="`fixed top-0 left-0  w-64 h-screen transition-transform ${x_transform}`"
            ...
            <div class=" h-full px-3 py-4 overflow-y-auto bg-escuro">
                ...
                <svg @click="moveSidebar('fecha'); $emit('overflowOn')" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                    width="24" class="ml-3  mb-4 scale-[110%] transition-all fill-claro group-hover:fill-claro">
                ...
                <ul class=" font-sm">
                    ...
                    <li>
                        <NuxtLink @click="moveSidebar('fecha'); $emit('titulo')" to="/" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                    ...
                    <li>
                        <NuxtLink @click="moveSidebar('fecha')" to="/safras" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            <svg class="scale-[50%] transition-all fill-claro group-hover:fill-claro"
                                xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                                <path
                            ...
                            <span class="ml-3">Safras</span>
                        </NuxtLink>
                    </li>
                    <li>
                        <NuxtLink @click="moveSidebar('fecha')" to="/estoque" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            <svg class="scale-[50%] transition-all fill-claro group-hover:fill-claro"
                                xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                                <path
                    ...
                    <li>
                        <NuxtLink @click="moveSidebar('fecha')" to="/tarefas" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            <svg class="scale-[50%] transition-all fill-claro group-hover:fill-claro"
                                xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                                <path
                    ...
                    <li>
                        <NuxtLink @click="moveSidebar('fecha')" to="/financeiro" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            <svg class="scale-[50%] transition-all fill-claro group-hover:fill-claro"
                                xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                                <path
                    ...
                    <li>
                        <NuxtLink @click="moveSidebar('fecha')" to="/compradores" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            <svg class="scale-[50%] transition-all fill-claro group-hover:fill-claro"
                                xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
                                <path
                            ...
                            <span class="ml-3">Compradores</span>
                        </NuxtLink>
                    </li>
                    <li>
                        <NuxtLink @click="moveSidebar('fecha')" to="/funcionarios" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            <svg class="scale-[50%] transition-all fill-claro group-hover:fill-claro"
                                xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                                <path
                    ...
                    <li>
                        <NuxtLink @click="moveSidebar('fecha')" to="/maquinas" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            <svg class="scale-[50%] transition-all fill-claro group-hover:fill-claro"
                                xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                                <path
                    ...
                    <li>
                        <NuxtLink @click="moveSidebar('fecha')" to="/minhaConta" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            <svg class="scale-[50%] transition-all fill-claro group-hover:fill-claro"
                                xmlns="http://www.w3.org/2000/svg" height="48" width="48" viewBox="0 -960 960 960">
                                <path
                    ...
                    <li>
                        <NuxtLink @click="moveSidebar('fecha')" to="/ajuda" href="#"
                            class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            <svg class="scale-[50%] transition-all fill-claro group-hover:fill-claro"
                                xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                                <path
