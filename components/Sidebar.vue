...
<template>
    ...
    <div class="block sm:hidden">
        <button @click="moveSidebar('abre')" type="button"
            class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-escuro rounded-lg sm:hidden ">
        ...
        <aside id="sidebar"
            ...
            <div class=" h-full px-3 py-4 overflow-y-auto bg-escuro">
                ...
                <svg @click="moveSidebar('fecha')" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                ...
                <ul class=" font-sm">
                    ...
                    <li>
                        <NuxtLink to="/" href="#" class="flex items-center p-1 text-claro hover:bg-verde rounded-lg">
                            ...
                            <span class="ml-3">Como Utilizar</span>
                        </NuxtLink>
                    </li>
